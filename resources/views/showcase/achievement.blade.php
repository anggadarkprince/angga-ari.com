...
@section('title', 'Story & Achievement')

@section('showcase_description', 'Achievement and story of life')

@section('showcase_content')
    <div class="mb-5">
        <p class="text-primary mb-4"><strong>EDUCATIONS</strong></p>
        <div>
    ...
    <div class="mb-5">
        <p class="text-primary mb-4"><strong>EXPERIENCES</strong></p>
        <div>
            <div class="card box-shadow mb-4">
                <div class="card-body pr-3">
                    <h5 class="card-title mb-1 d-flex justify-content-between">
    ...
    <div class="mb-5">
        <p class="text-primary mb-4"><strong>ACHIEVEMENTS</strong></p>
        <div>
            <div class="card box-shadow mb-4">
                <div class="card-body pr-3">
                    <h5 class="card-title mb-1 d-flex justify-content-between">
