        ...
        <div class="row">
            ...
            <div class="col-6 col-sm-5 col-md">
                <ul class="list-unstyled">
                    ...
                    <li><a href="{{ route('note.notebook') }}" class="link-muted">Note</a></li>
                    <li><a href="{{ route('finance.transaction') }}" class="link-muted">Finance</a></li>
                    <li><a href="{{ route('vault.password') }}" class="link-muted">Password Vault</a></li>
                </ul>
            </div>
