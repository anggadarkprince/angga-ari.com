<ul class="d-flex d-lg-block justify-content-between">
    <li{{ preg_match('/^vault.password/', Route::current()->getName()) ? ' class=active' : '' }}><a href="{{ route('vault.password') }}"><i class="icon-lock d-none d-md-inline-block"></i>Password</a></li>
