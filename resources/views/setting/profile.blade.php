    ...
    <form action="{{ route('setting.profile.update') }}" novalidate method="post" id="form-with-avatar">
        ...
        <fieldset>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control{{ $errors->first('username') ? ' is-invalid' : '' }}" id="username" name="username" placeholder="Unique username"
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input type="email" class="form-control{{ $errors->first('email') ? ' is-invalid' : '' }}" id="email" name="email" placeholder="Email address"
        ...
        <fieldset>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <div class="row">
                        <div class="col">
                            <select class="selectize select-year{{ $errors->first('birthday_year') ? ' is-invalid' : '' }}" name="birthday_year" id="birthday_year" placeholder="Year">
                        ...
                        <div class="col">
                            <select class="selectize select-month{{ $errors->first('birthday_month') ? ' is-invalid' : '' }}" name="birthday_month" id="birthday_month" placeholder="Month">
                        ...
                        <div class="col">
                            <select class="selectize select-date{{ $errors->first('birthday_date') ? ' is-invalid' : '' }}" name="birthday_date" id="birthday_date" placeholder="Date">
                                @for($i = 1; $i <= 31; $i++)
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <textarea class="form-control{{ $errors->first('about') ? ' is-invalid' : '' }}" id="about" name="about" placeholder="Tell about yourself" rows="3">{{ old('about', $user->about) }}</textarea>
